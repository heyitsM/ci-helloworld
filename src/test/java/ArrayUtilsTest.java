...
public class ArrayUtilsTest {
    ...
    @Test
    public void testCountOfArrayWithNoElements() {
        assertEquals(0, ArrayUtils.countOf(new int[]{}, 0));
    }

    @Test
    public void testCountOfArrayWithNoTargetElements() {
        assertEquals(0, ArrayUtils.countOf(new int[]{1, 2, 3}, 0));
    }

    @Test
    public void testCountOfArrayWithTargetElements() {
